...
Begin by creating the file `./x/tuckermint/types/types.go` to hold the customs types for your module. In Cosmos SDK applications, the convention is that modules live in the `./x/` folder.
...
To start your SDK module, define your `tuckermint.Whois` struct in the `./x/tuckermint/types/types.go` file:
