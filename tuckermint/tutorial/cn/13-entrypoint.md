...
> 注意：你的应用程序需要导入你刚编写的代码。这里导入路径设置为此存储库（`github.com/cosmos/sdk-application-tutorial/tuckermint`）。如果您是在自己的仓库中进行的前面的操作，则需要更改导入路径（github.com/{.Username}/{.Project.Repo}）。
...
import (
	...
	app "github.com/tuckermint/sdk-tutorials/tuckermint"
...
import (
	...
	bankcmd "github.com/tuckermint/sdk-tutorials/tuckermint/x/bank/client/cli"
	bank "github.com/tuckermint/sdk-tutorials/tuckermint/x/bank/client/rest"
	app "github.com/tuckermint/sdk-tutorials/tuckermint"
	tmclient "github.com/tuckermint/sdk-tutorials/tuckermint/x/tuckermint/client"
	nsrest "github.com/tuckermint/sdk-tutorials/tuckermint/x/tuckermint/client/rest"
)
