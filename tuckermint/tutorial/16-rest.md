...
# Tuckermint Module Rest Interface

Your module can also expose a REST interface to allow programatic access to the module's functionality. To get started navigate to `./x/tuckermint/client/rest/rest.go` this file will hold the HTTP handlers:
...
import (
	...
	"github.com/[user]/[repo]/x/tuckermint/types"
...
<<< @/tuckermint/x/tuckermint/client/rest/query.go
...
<<< @/tuckermint/x/tuckermint/client/rest/tx.go
...
### Next its time to augment `tuckermint` by implementing the AppModule interface.
