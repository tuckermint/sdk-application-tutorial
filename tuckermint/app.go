...
var _ simapp.App = (*tuckermintApp)(nil)
...
func (app *tuckermintApp) GetKey(storeKey string) *sdk.KVStoreKey {
	return app.keys[storeKey]
}

// GetTKey returns the TransientStoreKey for the provided store key
func (app *tuckermintApp) GetTKey(storeKey string) *sdk.TransientStoreKey {
...
func (app *tuckermintApp) Codec() *codec.Codec {
	return app.cdc
}

// SimulationManager implements the SimulationApp interface
func (app *tuckermintApp) SimulationManager() *module.SimulationManager {
	return app.sm
}
