...
func TestMsgSetNameGetSignBytes(t *testing.T) {
	...
	expected := `{"type":"tuckermint/SetName","value":{"name":"maTurtle","owner":"cosmos1d4js690r9j","value":"1"}}`
...
func TestMsgBuyNameGetSignBytes(t *testing.T) {
	...
	expected := `{"type":"tuckermint/BuyName","value":{"bid":[{"amount":"10","denom":"atom"}],` +
...
func TestMsgDeleteNameGetSignBytes(t *testing.T) {
	...
	expected := `{"type":"tuckermint/DeleteName","value":{"name":"maTurtle","owner":"cosmos1d4js690r9j"}}`
